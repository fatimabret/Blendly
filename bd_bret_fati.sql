...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2024 a las 01:45:33
...
INSERT INTO `consulta` (`id_consulta`, `correo_consulta`, `telefono_consulta`, `motivo_consulta`, `texto_consulta`, `leido_consulta`, `respuesta_consulta`) VALUES
(1, 'fatimabret@outlook.com', '', 'prueba', 'dia de prueba uno.', 1, ''),
(2, 'ejemplo@com.ar', '+543790800080', 'prueba dos', 'primer dia de prueba, segunda vez.', 1, ''),
(3, 'juanperez@example.com', '8057939811', 'Cumplido', 'Satisfecho con sus productos, muy buena pagina.', 0, ''),
(4, 'juanperez@example.com', '8057939811', 'Cumplido', 'Satisfecho con sus productos, muy buena pagina.', 1, ''),
(5, 'beatrizcolumia@contac.exe', '4944483909', 'Calidad', 'Producto de muy buena calidad con unos precios increíbles.', 0, ''),
(6, 'juanperez@example.com', '0489903899', 'Reactivar mi cuenta', 'Paso mucho tiempo de mi ultimo inicio de sesión, si me pueden reactivar mi cuenta, gracias.', 1, 'Listo!'),
(10, 'beatrizcolum@contac.exa', '0489903899', 'hola', '12345', 1, 'respuesta!'),
(11, 'juanperez@example.com', '0489903899', '1242567', 'vbnhjk', 0, ''),
(12, 'beatrizcolum@contac.exa', '0489903899', 'yy', '8923fnef', 1, 'hola'),
(13, 'adolfoluis@gmail.com', '0880093038', 'degustacion', 'abrirán otra sucursal por el centro?', 0, ''),
(14, 'juanperez@example.com', '0489903899', 'probamos', 'consultas', 1, 'hola chau'),
(15, 'luisacabe@gmail.com', '0880093038', 'Felicitaciones', 'Aviso que me llego espléndidamente los productos', 1, ''),
(16, 'luisacabe@gmail.com', '0880093038', 'Pequeña pregunta', 'aceptan pedidos los domingos?', 1, 'Aceptamos y preparamos los pedidos las 24hs, los 7 dias a la semana.Saludos!'),
(17, 'luisacabe@gmail.com', '0880093038', 'Horario', 'Que hora esta abierto el local?', 0, ''),
(18, 'spirtmar@gmail.com', '0489903899', 'probando', 'puedo retirar en el local mi pedido?', 0, '');
...
INSERT INTO `producto` (`id_producto`, `categoria_producto`, `nombre_producto`, `descripcion_producto`, `precio_producto`, `stock_producto`, `imagen_producto`, `estado_producto`, `proveedor_producto`, `vendidos_producto`) VALUES
...
(3, 1, 'Somul', 'Vino bianco fresco con aromi di agrumi e fiori.', 6700.75, 0, '1718652237_somul.jpeg', 1, 3, 0),
...
(10, 1, 'Drink White', 'Much heath...', 556.00, 7, '1718716690_whitedrink.jpeg', 0, 3, 1),
...
INSERT INTO `usuario` (`id_usuario`, `perfil_usuario`, `nombre_usuario`, `apellido_usuario`, `correo_usuario`, `edad_usuario`, `pass_usuario`, `estado_usuario`, `direccion_usuario`) VALUES
