        <h1 class="display-3 text-center text-white m-2 pb-2">Detalles de Venta</h1>

        <div class="container text-end">
            <a href="<?php echo base_url('ventas');?>"class="boton bt bnt m-auto p-2"><img src="<?php echo base_url('assets/img/icons/back.png');?>" alt="" width="25" height="25">Volver</a>
        </div>
    </main>
