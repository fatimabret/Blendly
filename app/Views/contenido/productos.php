        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="sidebar">
                        ...
                        <div class="container-fluid mt-3 mb-3">
                            <form class="d-flex" action="<?= base_url('producto/buscar') ?>" method="get">
                                ...
                                <button class="botones btn bt" style="background: #1b243a;" type="submit">
                                    <img src="<?= base_url('assets/img/icons/buscar.png') ?>" alt="Buscar" width="30" height="30">
                                </button>
                            </form>
                        </div>
                    </nav>
                    ...
                    <ul class="list-group">
                        ...
                        <?php foreach ($categorias as $categoria): ?>
                            <li class="list-group-item">
                                <a href="<?= base_url('categorias/categoria/' . $categoria['id_categoria']) ?>" class="text-titulo color-nav">
                        ...
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/mas_vendidos') ?>" class="text-titulo color-nav"><strong>Más Vendidos</strong></a>
                        </li>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/orden/asc') ?>" class="text-titulo color-nav"><strong>Precio: Menor a Mayor</strong></a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/orden/desc') ?>" class="text-titulo color-nav"><strong>Precio: Mayor a Menor</strong></a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/orden/alfabeto/asc') ?>" class="text-titulo color-nav"><strong>A-Z</strong></a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/orden/alfabeto/desc') ?>" class="text-titulo color-nav"><strong>Z-A</strong></a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/orden/fecha/desc') ?>" class="text-titulo color-nav"><strong>Más nuevos</strong></a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?= base_url('categorias/orden/fecha/asc') ?>" class="text-titulo color-nav"><strong>Más antiguos</strong></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="conteiner-car">
                    <div class="row-producto row row-cols-1 row-cols-md-2">
            ...
            <ul class="pagination justify-content-center">
                ...
                <?php if ($current_page > 1): ?>
                    <li class="page-item m-1">
                        <a class="page-link rounded-circle" href="<?= base_url('productos/' . ($current_page - 1)) ?>" aria-label="Previous">
                ...
                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <li class="page-item <?= ($i == $current_page) ? 'active' : '' ?> m-1">
                        <a class="page-link rounded-circle" href="<?= base_url('productos/' . $i) ?>"><?= $i ?></a>
                    </li>
                <?php endfor; ?>
                
                <?php if ($current_page < $total_pages): ?>
                    <li class="page-item m-1">
                        <a class="page-link rounded-circle" href="<?= base_url('productos/' . ($current_page + 1)) ?>" aria-label="Next">
