        ...
        <div class="text p-2">
            <h4 class="text-end me-5">
                <a href="<?php echo base_url('productos');?>" class="botones btn btn-light custom-link m-auto d-inline-block me-3 p-2 pt-2">Continuar comprando</a>
            </h4>
        </div>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('quitar/' . $item['rowid']); ?>" class="btn btn-danger">Eliminar</a></td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td colspan="3"><a href="<?php echo base_url('vaciar'); ?>" class="btn btn-warning">Vaciar Carrito</a></td>
                                <td colspan="3"><a href="<?php echo base_url('guardar_venta'); ?>" class="btn btn-success">Continuar Compra</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
